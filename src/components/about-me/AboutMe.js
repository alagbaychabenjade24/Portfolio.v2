        ...
        <section className='aboutMe'>
            ...
            <div className='aboutMe__content'>
                ...
                <p className='aboutMe__content__experience'>
                    I'm a part-time IT Instructor for Japanese students, where I
                    help them learn how to write code and create websites that
                    they can show off. Our lessons range from the foundations of
                    web design to the deployment of a full-scale website using
                    modern technology.
                </p>

                <p className='aboutMe__content__mission'>
                    As a front-end developer, my goal is to improve every day
                    for me to create the most efficient and scalable websites
                    possible. I make it my mission to continue growing and be a
                ...
                <p className='aboutMe__content__interests'>
                    ...
                    code, create side projects, and watch movies or listen to
                    musics.
                </p>
